var data = [
    ...
    var clusterendpoint = 'example-docdb-cluster.cluster-cwwnbexip9py.eu-west-2.docdb.amazonaws.com:27017';
    var username = 'docadmin';
    ...
    // Connection URL
    const connstring = `mongodb://${username}:${password}@${clusterendpoint}/sample-database?tls=false&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false`;
